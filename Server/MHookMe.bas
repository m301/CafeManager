...
' *************************************************************************
'  Copyright ©1997-2001 Karl E. Peterson and Zane Thomas,
...
Public Function HookFunc(ByVal hWnd As Long, ByVal msg As Long, ByVal wp As Long, ByVal lp As Long) As Long
   ...
   '
   ' For this demo, and in the accompanying EXE, the
   ' next line should be: Dim obj As FPrinters
   ' It is left As Object here, so you may save this
   ' BAS to your Templates folder for ready inclusion
   ' in new projects.
   ' Dim obj As Object
   Dim obj As FPrinters
   ' ****************************************************
