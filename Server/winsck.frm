   ...
   Begin VB.Frame mfrm 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.ComboBox idType 
            Height          =   315
            ItemData        =   "winsck.frx":1EB45
            Left            =   1200
            List            =   "winsck.frx":1EB47
            Style           =   2  'Dropdown List
            TabIndex        =   102
            Top             =   1200
            Width           =   1815
...
'
Private Declare Function GetWindowLong Lib "user32" Alias "GetWindowLongA" (ByVal hwnd As Long, ByVal nIndex As Long) _
As Long
...
Private Sub cmdCommand44_Click()
...
If Command6.Caption = "Normal" Then
lvwDB.View = lvwIcon
Command6.Caption = "Show Detail"
cmbChooseView.Text = "Icon View"
Else
lvwDB.View = 3
cmbChooseView.Text = "Table View"
Command6.Caption = "Normal"
End If
End Sub
...
lvwDB.Visible = True
'ctlLVExportManager1.BindToListView uDb
'ctlLVExportManager1.title = "User's Database"
'''Price List
...
Private Sub hcom_Click(Index As Integer)
mShow Index
...
'FIXIT: Declare 'dat' with an early-bound data type                                        FixIT90210ae-R1672-R1B8ZE
...
Private Sub Broadcast()
       On Error Resume Next
        ...
        Next
End Sub
'FIXIT: Declare 'cCharge' with an early-bound data type                                    FixIT90210ae-R1672-R1B8ZE

Private Sub TabStrip1_Click()
'FIXIT: frm(TabStrip1.SelectedItem.Index property has no Visual Basic .NET equivalent and will not be upgraded.     FixIT90210ae-R7594-R67265
'FIXIT: 'SelectedItem.Index' is not a property of the generic 'Form' object in Visual Basic .NET. To access 'SelectedItem.Index' declare 'frm(TabStrip1' using its actual type instead of 'Form'     FixIT90210ae-R1460-RCFE85
...
End Sub
'FIXIT: Declare 'wSend' with an early-bound data type                                      FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'aCalc' with an early-bound data type                                      FixIT90210ae-R1672-R1B8ZE
Public Function RateCalc(Requested_Time As Integer) As Integer
'FIXIT: Declare 'tTot' and 'tTme' and 'i' with an early-bound data type                    FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'clCheck' with an early-bound data type                                    FixIT90210ae-R1672-R1B8ZE
Private Sub clCheck()
...
'FIXIT: Declare 'lClear' with an early-bound data type                                     FixIT90210ae-R1672-R1B8ZE
...
End Function
'FIXIT: Declare 'lsub14' with an early-bound data type                                     FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'mShow' with an early-bound data type                                      FixIT90210ae-R1672-R1B8ZE
...
'FIXIT: Declare 'sResize' with an early-bound data type                                    FixIT90210ae-R1672-R1B8ZE
...
Dim NewStyle As Long
    ...
    NewStyle = GetWindowLong(cHome.hwnd, GWL_STYLE)
    NewStyle = NewStyle Or BS_RIGHT
    SetWindowLong cHome.hwnd, GWL_STYLE, NewStyle
    cHome.Refresh
''end align

End Function

'FIXIT: Declare 'cLog' with an early-bound data type                                       FixIT90210ae-R1672-R1B8ZE
