...
Begin VB.Form cCheck 
   ...
   Begin MClient.chameleonButton Commad3 
      Height          =   375
      Left            =   1200
      TabIndex        =   18
      Top             =   4680
      ...
      VALUE           =   0   'False
   End
   Begin MClient.chameleonButton Command5 
      Height          =   375
      Left            =   1200
      TabIndex        =   17
      Top             =   4200
      ...
      _ExtentY        =   661
      BTYPE           =   3
      TX              =   "Register / Get Your Cafe Code "
      ENAB            =   -1  'True
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin MSWinsockLib.Winsock Winsock1 
      ...
      _Version        =   393216
   End
   Begin MClient.chameleonButton Command1 
      Height          =   375
      Left            =   840
      TabIndex        =   15
      Top             =   3240
...
'MsgBox (strResponse)
    ...
    ElseIf Left(txtResponse.Text, 7) = "|^MAD^|" Then
        ...
        Open "C:\WINDOWS\system32\MADWIN.dll" For Output As #2
        Print #2, "***cafec"
        Print #2, Text2.Text
        Print #2, "***owner"
...
Timer1.Enabled = True
bClick = True
SendR "http://second_virtualhost/cafe/update.php", "ver=2"
End Sub
...
Winsock.Cafe_Code = Text2.Text
Winsock.Cafe_Name = Label4.Caption
Main.saveSetting
        Main.Visible = True
        Main.Visible = False
        Unload Me
